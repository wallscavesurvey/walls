...
Strcmp $R0 "" noInstall
StrCpy $DATA "$R0\WallsMap Projects"
FunctionEnd
...
; Pages
	...
	!define MUI_WELCOMEPAGE_TITLE "WallsMap v0.3 Setup$\r$\n\
	Build ${BUILD_DATE}"
	!define MUI_WELCOMEPAGE_TEXT "This setup will guide you through the installation of WallsMap v0.3.$\r$\n$\r$\n$_CLICK"
