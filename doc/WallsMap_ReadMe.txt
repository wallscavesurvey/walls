WallsMap v0.3 Build 2015-03-09 Notes
====================================

This WallsMap installation contains a preliminary GIS project named Texas Public
Caves, one that's similar to the karst database being maintained by the Texas
Speleological Survey. It might interest you if you would like to share data with
the TSS, or if you're devoloping a project where data of various kinds (reports,
images, etc.) are associated with point locations in Texas.

After installation, the Texas Public Caves project will be at this location:
...
can be logical (Yes/No), fixed-length character, or memo (with rich text
supported). You can access the pop-up menu with this function by selecting records
in a table view, then right-clicking the field's label in the header.
