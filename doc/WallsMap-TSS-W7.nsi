...
!define PRODUCT_SFX "-TSS"
!define PRODUCT_ALTSFX ""
!define PRODUCT_WEB_SITE "http://texasspeleologicalsurvey.org/software/wallsmap-tss/"
...
Function RunWallsMap
ShellExecAsUser::ShellExecAsUser "open" "$INSTDIR\WallsMap.exe"
FunctionEnd
...
!define MUI_FINISHPAGE_RUN_FUNCTION RunWallsMap
...
; Shortcuts
  ...
  WriteINIStr "$INSTDIR\WallsMap${PRODUCT_SFX}.url" "InternetShortcut" "URL" "${PRODUCT_WEB_SITE}" 
