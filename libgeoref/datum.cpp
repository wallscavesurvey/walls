...
/****************************************************************************/
/*                                                                          */
/* ellipsoid: index into the geo_gEllipsoid[] array, in which                   */
/*                                                                          */
...
/* data contained in the structure array geo_gEllipsoid[], which was obtained   */
...
struct GEO_ELLIPSOID const geo_gEllipsoid[] = {
...
{
  /* flattening */
  double f = 1.0 / geo_gEllipsoid[geo_gDatum[geo_datum].ellipsoid].invf;
    
  *es = 2 * f - f*f;                                 /* eccentricity^2 */
  *a  = geo_gEllipsoid[geo_gDatum[geo_datum].ellipsoid].a;   /* semimajor axis */
}
