...
CNCSError CNCSJP2File::Open(wchar_t *pName, bool bWrite)
{
	...
	if(m_nRefs == 0) {
		...
		if(NCSecwNetBreakdownUrl(CHAR_STRING(pName), &pProtocol, &nProtocolLength,
			...
			if(pProtocol && (!_strnicmp(pProtocol, "ecwp:", strlen("ecwp:")) || !_strnicmp(pProtocol, "ecwps:", strlen("ecwps:")))) {
				bIsECWP = true;
			}
		}
		if(bIsECWP) {
			...
			if(m_FileInfo.pBands) {
				...
				/*if(sscanf(m_FileInfo.pBands[0].szDesc, NCS_BANDDESC_Band, &nBand) != 1)*/ {
					...
					for(b = 0; b < m_FileInfo.nBands; b++) {
						...
						if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_Red)) {
						...
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_Green)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::COLOR;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::G;					
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_Blue)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::COLOR;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::B;					
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_All)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::COLOR;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::WHOLE_IMAGE;
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_RedOpacity)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::OPACITY;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::R;					
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_GreenOpacity)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::OPACITY;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::G;					
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_BlueOpacity)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::OPACITY;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::B;					
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_AllOpacity)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::OPACITY;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::WHOLE_IMAGE;					
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_RedOpacityPremultiplied)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::PREMUL_OPACITY;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::R;					
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_GreenOpacityPremultiplied)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::PREMUL_OPACITY;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::G;					
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_BlueOpacityPremultiplied)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::PREMUL_OPACITY;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::B;					
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_AllOpacityPremultiplied)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::PREMUL_OPACITY;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::WHOLE_IMAGE;					
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_Greyscale)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::COLOR;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::Y;					
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_GreyscaleOpacity)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::OPACITY;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::Y;					
						} else if(!_stricmp(m_FileInfo.pBands[b].szDesc, NCS_BANDDESC_GreyscaleOpacityPremultiplied)) {
							def.m_eType = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::PREMUL_OPACITY;
							def.m_eAssociation = CNCSJP2HeaderBox::CNCSJP2ChannelDefinitionBox::Y;					
						} else {
...
{
	BOOLEAN bRetVal = (!(_stricmp(pInfo->szProjection,"RAW") == 0)) ||
					  (!(_stricmp(pInfo->szDatum,"RAW") == 0)) ||
					  (pInfo->fOriginX != 0) ||
					  (pInfo->fOriginY != 0) ||
