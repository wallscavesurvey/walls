...
/*DMcK=================================*/
enum XML_PredefinedEntityParsing {
  XML_PREDEFINED_ENTITY_PARSING_NEVER=0,
  XML_PREDEFINED_ENTITY_PARSING_ALWAYS
};

enum XML_GeneralEntityParsing {
  XML_GENERAL_ENTITY_PARSING_NEVER=0,
  XML_GENERAL_ENTITY_PARSING_ALWAYS
};

/* Controls parsing of the predefined entities, &lt, &gt, &apos, &quot,
and  &amp.  If set to XML_PREDEFINED_ENTITY_PARSING_ALWAYS, the predefined
entities will always be expanded; that is, '&lt;' becomes '<', '&gt;'
becomes '>', etc...  If set to XML_PREDEFINED_ENTITY_PARSING_NEVER, then
the predefined entities will be passed to handlers just as they appear in
the input stream.  The default value is XML_PREDEFINED_ENTITY_PARSING_ALWAYS.*/

XMLPARSEAPI(void)
XML_SetPredefinedEntityParsing(XML_Parser parser,
                               enum XML_PredefinedEntityParsing parsing);
XMLPARSEAPI(void)
XML_SetGeneralEntityParsing(XML_Parser parser,
                               enum XML_GeneralEntityParsing parsing);
/*DMcK=================================*/
