...
enum {
	M_MARKERS = 1, M_NAMES = 2, M_NOTES = (1 << 2), M_FLAGS = (1 << 3), M_FLAGGED = (1 << 4), M_PRINT = (1 << 5),
...
//styletyp flags --
enum e_style {
	SEG_NOMARK = 1, SEG_NONAME = 2, SEG_NONOTE = 4, SEG_NOFLAG = 8,
...
enum {
	HDR_BKGND, HDR_LABELS, HDR_MARKERS, HDR_GRIDLINES,
