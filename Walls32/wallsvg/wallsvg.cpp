...
enum ew2d_flg {
	FLG_WALLS_SHP = 1, FLG_WALLS_SYM = 2, FLG_DETAIL_SHP = 4, FLG_DETAIL_SYM = 8,
...
enum ew2d_idx {
	ID_REF, ID_DETAIL, ID_DETAIL_SHP, ID_DETAIL_SYM,
...
enum e_gtyp {
	W2D_SVG, W2D_BACKGROUND, W2D_REF, W2D_SURVEY, W2D_VECTORS, W2D_LRUDS,
