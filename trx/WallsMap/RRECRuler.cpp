   ...
   ============================================================*/
{
	...
	if( m_mode == MODE_INCH )
	{
		int inch4 = ( int ) ( ( double ) m_pxPerInch / 4.0 +.5 );
		int inch8 = ( int ) ( ( double ) m_pxPerInch / 8.0 +.5 );
		...
		// Drawing numbers
		for( t = leftmarg + m_pxPerInch ; t < rect.right - m_margin ; t += m_pxPerInch )
		{
	...
	{
		int cm = ( int ) ( ( double ) m_pxPerInch / 2.54 + .5 );
